        ...
        for (ix, graph) in enumerate(iterator):
            ...
            for node_id in range(graph.num_nodes):
                ...
                for class_idx in range(out.size(1)): 
                    ...
                    torch.save(explanation.cpu(), f"{self.out_dir}/graph_{ix}_node_{node_id}_class_{class_idx}.pt")
